 ...
 <form id="formDiscEdit" action="alterDisc.php" method="post">
    ...
    <label>ALGUM PROFESSOR LECIONA ESSA DISCIPLINA JUNTO A VOCÊ?
      ...
      <div class="spaceAround">
        ...
        <div class="etiquetas row">
          <div class="col-3">
            <input type="radio" name="etiquetas" id="roxo" value="1" <?php if($cor==1){ ?>checked<?php }else{} ?> required="">
          </div>
          <div class="col-3">
            <input type="radio" name="etiquetas" id="amarelo" value="2" <?php if($cor==2) { ?>checked<?php }else{} ?>>
          </div>
          <div class="col-3">
            <input type="radio" name="etiquetas" id="verde" value="3" <?php if($cor==3){ ?>checked<?php }else{} ?>>
          </div>
          <div class="col-3">
            <input type="radio" name="etiquetas" id="azul" value="4" <?php if($cor==4){ ?>checked<?php }else{} ?>>
          </div>
        </div>
      </div>
    </form>